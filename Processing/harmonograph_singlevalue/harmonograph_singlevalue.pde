...
String [] subtext;
Serial myPort;
String filepath = "/Users/benreynolds/Documents/MakeMIT/HeartonographSubmission/HeartRateData/data.txt";
...
void setup(){
 ...
 String portAddress = "/dev/cu.usbmodem1421"
 myPort = new Serial(this, portAddress, 9600);
 myPort.bufferUntil('\n');
}
...
void draw() {
 ...
 //readData("/Users/benreynolds/Documents/MakeMIT/HeartRateData/data.txt");
 readData(filepath);
